...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/svg+xml" sizes="64x64" href="images/TS-1.png" >
        ...
        <section class="ftco-section ftco-cart">
            <div class="container">
                <div class="row justify-content-center mb-3 pb-3">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        <a class="navbar-brand" href="options.html"><img src="images/LogoTaylor.png" width="150" height="" alt="LogoGucci"/></a>
            ...
            <div class="container center">
                <div class="product d-flex flex-column">
                    <a href="ProductosController?action=add" class="btn btn-black px-3 py-2">A�adir Producto<span></span></a>
                </div>
            </div>
