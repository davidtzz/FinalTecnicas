...
<html lang="en">
                    ...
                    <div class="col-lg-12 d-block">
                        <div class="row d-flex">
                            ...
                            <div class="col-md pr-4 d-flex topper align-items-center">
                                ...
                                <span class="text">taylorswift@gmail.com</span>
                            </div>
                            <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
                          lass="text">ENTREGA DE      <span c 3 A 5 DÍAS HÁBILES&amp; Y DEVOLUCIONES GRATUITAS
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="start.html"><img src="images/LogoTaylor.png" width="150" height="" alt="LogoGucci"/></a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="products.jsp">Mercancía</a>
                        </div>
                    </li>
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">Taylor Swift</h2>
                        <p>© 2016 - 2020 Taylor Swift - Todos los derechos reservados. LICENCIA SIAE # 2294/I/1936 y 5647/I/1936.</p>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-5">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="#" class="py-2 d-block">Mercancía</a></li>
                    ...
                    <div class="ftco-footer-widget mb-4">
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon icon-envelope"></span><span class="text"> taylorswift@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
